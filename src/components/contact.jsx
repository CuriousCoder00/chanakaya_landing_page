          ...
          <div className="row  justify-content-center">
            <div className="col-lg-5 mx-3">
              ...
              <div className="row py-2 rounded shadow my-3 bg-white align-middle border">
                ...
                >
                  <span>
                    <i className="bi bi-facebook mx-2"></i> Chankaya Coaching
                    Classes - @chankayaeducationgroup
                  </span>
                </Link>
              </div>
              <div className="row py-2 rounded shadow my-3 bg-white align-middle border">
                ...
                >
                  <span>
                    <i className="bi bi-geo-alt-fill mx-2"></i>Bundi, College
                    Road, in Front of Police Kotwali, New Colony - 323001
                  </span>
                </Link>
              </div>
            </div>
            <div className="col-lg-6 ms-2 p-3 bg-white">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3603.1005625967887!2d75.64386467521958!3d25.434901277558648!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x396f094b61cbc461%3A0xba7c306c491af72!2sChankaya%20Coaching%20Classes-%20Bundi!5e0!3m2!1sen!2sin!4v1690194200518!5m2!1sen!2sin"
                style={{ border: "0" }}
                allowFullScreen=""
                loading="lazy"
