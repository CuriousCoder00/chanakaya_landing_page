      ...
      <div className="container mt-5">
        <div className="row my-4 bg-white rounded shadow">
          ...
          <div className="col-md-9 p-3">
            ...
            <div>
              ...
              Paint, Notepad, WordPad, MS Office Word, Excel, Power Point, Nudi,
              Typing Skills, Internet Concept
            </div>
        ...
        <div className="row my-4 bg-white rounded shadow">
          ...
          <div className="col-md-9 p-3">
            ...
            <div>
              <strong className="fs-6">Syllabus: </strong>
              Accounting Basics, Journal Entries, Company Creation, Ledger, Vouchers, Trading, P and L, B/S with GST
            </div>
        ...
        <div className="row my-4 bg-white rounded shadow">
          ...
          <div className="col-md-9 p-3">
            <dt className="fs-4">Post Graduation Diploma in Computer Applications</dt>
            <div>
              <strong className="fs-6">Course Duration: </strong>1 Year
            </div>
            <div>
              <strong className="fs-6">Syllabus: </strong>
              DOS, MS Office, Nudi, Tally ERP 9.0, DTP, Internet Concepts, Web Designing, C Language, C++, VB 6.0
            </div>
        ...
        <div className="row my-4 bg-white rounded shadow">
          ...
          <div className="col-md-9 p-3">
            <dt className="fs-4">Diploma in Computer Teacher Training Course</dt>
            <div>
              <strong className="fs-6">Course Duration: </strong>1 Year
            </div>
            <div>
              <strong className="fs-6">Syllabus: </strong>
              DOS, MS Office, Tally ERP 9.0, DTP, C Language, Internet Concepts
            </div>
